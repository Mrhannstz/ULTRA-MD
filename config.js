...
const defaultOwner = '255692540143';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || 'HANSTZ';  // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '255756530143';  // put your number here
